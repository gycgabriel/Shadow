...
public class MoveState : State<EnemyAI>
{
     ...
     */
    private bool CanMove(EnemyAI _owner, Vector2 moveDirection)
    {
    ...
    private void NonAlertMove(EnemyAI _owner)
    {
    ...
    private void AlertMove(EnemyAI _owner)
    {
